...
/**
 * Brand-neutral by construction: APP_ORIGIN/APP_NAME are the per-brand vars
 * already wired in wrangler.jsonc (env.holdfast / env.gunner) and already used
 * this same way elsewhere in auth.ts (magic-link URL, Google redirect_uri).
 * No brand id is ever referenced here.
 */
