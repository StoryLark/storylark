...
// prose-convention block parser. The conventions are documented in
// docs/content-pipeline.md and verified against the live site pages.
...
/**
 * Parses a markdown prose body into StoryReader blocks:
 *   ---                       → scene-break
 ...
 *
 * `siteOrigin` (e.g. https://gunnerthelab.com) turns a root-relative image
