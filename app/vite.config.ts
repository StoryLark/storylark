...
// The build "mode" IS the brand id: vite build --mode holdfast | gunner.
export default defineConfig(({ mode }) => {
  const brandId = mode === 'gunner' ? 'gunner' : 'holdfast';
    ...
    plugins: [
      ...
      VitePWA({
        ...
        injectManifest: {
          ...
          globIgnores:
            brandId === 'gunner'
              ? ['**/fonts-holdfast-*', '**/cormorant-*', '**/cinzel-*', '**/lora-*', '**/ibm-plex-mono-*']
              : ['**/fonts-gunner-*', '**/newsreader-*', '**/inter-*'],
