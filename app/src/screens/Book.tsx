 ...
 * NOUNS — on holdfast the units are CHAPTERS of a BOOK (never "book 1 of 2"),
 * on gunner (single-story books, if ever routed here) the unit is a STORY.
 */
function DownloadBookButton({ book }: { book: BookEntry }): JSX.Element | null {
  ...
  const whole = NOUNS.collection ?? NOUNS.unit; // 'book' (holdfast) / 'story' (gunner)
