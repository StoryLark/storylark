 ...
 * origins only, so the marketing-site origin is pinned per brand id here.
 */
const INSTALL_PAGE_URL = BRAND.id === 'gunner' ? 'https://gunnerthelab.com/app' : 'https://holdfastpress.com/app';
    ...
    <div class="screen about-screen">
      ...
      {BRAND.id === 'gunner' && (
        <section class="settings-section">
          <h2>About these stories</h2>
          <p class="settings-note">
            The Adventures of Gunner the Lab is a work of family storytelling. Some of it really happened, to real
            people, in real places, with real animals, and at times you will even meet them by their real names. But
            these are stories first. Events, locations, timelines, and the people in them have been changed,
            combined, trimmed, and padded with plenty of fiction for the sake of a better tale. Mostly true, always
            fun, and definitely Gunner's fault.
          </p>
          <p class="settings-note">
            Every one of these stories starts in the author's own head. From there, AI helps with the telling:
            shaping, structuring, and polishing each tale so it reads the way it was meant to be enjoyed. The ideas,
            the heart, and the family are all his; the AI simply helps put them on the page.
          </p>
        </section>
      )}
